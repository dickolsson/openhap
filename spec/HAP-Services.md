...
4. **Custom services**: Vendors may define custom services using their own UUIDs
   outside the Apple base range.

5. **Deprecated services**: The legacy Fan service (0x40) is deprecated in favor
   of Fanv2 (0xB7).
